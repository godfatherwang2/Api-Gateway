package cn.wx.gateway.core.socket.handlers;


import cn.wx.gateway.core.bind.IGenericReference;
import cn.wx.gateway.core.executor.result.SessionResult;
import cn.wx.gateway.core.session.GatewaySession;
import cn.wx.gateway.core.session.defaults.DefaultGatewaySessionFactory;
import cn.wx.gateway.core.socket.BaseHandler;
import cn.wx.gateway.core.socket.agreement.AgreementConstants;
import cn.wx.gateway.core.socket.agreement.GatewayResultMessage;
import cn.wx.gateway.core.socket.agreement.RequestParser;
import cn.wx.gateway.core.socket.agreement.ResponseParser;
