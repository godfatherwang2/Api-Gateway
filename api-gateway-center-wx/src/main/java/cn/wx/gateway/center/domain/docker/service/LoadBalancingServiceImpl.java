 ...
 * @description:TODO
 * @author: Lenovo
 * @create: 2024/11/9 下午9:11
 */
@Service
public class LoadBalancingServiceImpl extends AbstractLoadBalancing{

    private Logger logger = LoggerFactory.getLogger(LoadBalancingServiceImpl.class);
